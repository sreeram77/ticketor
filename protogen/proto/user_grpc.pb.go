...
func (c *userServiceClient) Get(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) Get(context.Context, *UserIDRequest) (*UserResponse, error) {
